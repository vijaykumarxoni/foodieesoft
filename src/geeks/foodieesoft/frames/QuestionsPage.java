...
public class QuestionsPage extends javax.swing.JFrame {
    ...
    public QuestionsPage() {
        ...
        JTableHeader header = this.jTableQuestions.getTableHeader();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextFieldQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 260, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 460, 380));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 810, 420));
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        int question_id = questions_list.get(this.jTableQuestions.getSelectedRow()).getQuestion_id();
        int i = dbManager.removeQuestions(new Questions(question_id, 0, 0, 0, "", "", ""));
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        if (!(this.jTextFieldQuestion.getText().equals("Enter Question...") || this.jTextFieldQuestion.getText().equals(""))) {
            ...
            int status = dbManager.saveQuestions(new Questions(user_id, CurrentDate.getCurrentDate(), this.jTextFieldQuestion.getText()));
            showInTable();
            this.jTextFieldQuestion.setText("Enter Question...");
            if (status != 0) {
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (!(this.jTextFieldQuestion.getText().equals("Enter Question...") || this.jTextFieldQuestion.getText().equals(""))) {
            int question_id = questions_list.get(this.jTableQuestions.getSelectedRow()).getQuestion_id();
            int i = dbManager.modifyQuestions(new Questions(question_id, 0, 0, user_id, "", CurrentDate.getCurrentDate(),
    ...
    public void checkPermissions(int user_cat_id) {
        ...
        for (Permissions permissions : permissions_name_list) {
            if ((permissions.getPermission_name().equalsIgnoreCase("Add Question"))) {
                this.jButtonSave.setEnabled(true);
            } else if ((permissions.getPermission_name().equalsIgnoreCase("Update Question"))) {
                this.jButtonUpdate.setEnabled(true);

            } else if ((permissions.getPermission_name().equalsIgnoreCase("Delete Question"))) {
